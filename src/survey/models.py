...
class Question(CreationTimeStamp):
    ...
    # options = ListField(models.CharField(max_length=300, blank=True), null=True)
    options = models.JSONField(max_length=300, blank=True)
...
class QuestionAnswer(CreationTimeStamp):
    ...
    # responses = ListField(models.CharField(max_length=300, blank=True))
    responses = models.JSONField(max_length=300, blank=True)
